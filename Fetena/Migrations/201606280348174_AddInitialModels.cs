namespace Fetena.Migrations
{
    ...
    public partial class AddInitialModels : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        ProgrammingLanguage = c.String(nullable: false, maxLength: 255),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        PossibleAnswer = c.String(nullable: false),
                        QuizId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Quizs", t => t.QuizId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Answers", "QuizId", "dbo.Quizs");
            DropForeignKey("dbo.Choices", "QuizId", "dbo.Quizs");
            ...
            DropIndex("dbo.Choices", new[] { "QuizId" });
            DropIndex("dbo.Answers", new[] { "QuizId" });
